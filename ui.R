...
shinyUI(dashboardPagePlus(
    dashboardHeaderPlus(title = "TLC DATA HUB", 
                        titleWidth = 330,
    ...
    dashboardSidebar(width = 330, 
                     ...
                     introBox(sidebarMenu(id = 'side',br(),
                                 menuItem("Menu", tabName = "dashboards", icon = icon("dashboard"),
                                          menuSubItem("Trip Viz",tabName = "m1", icon = icon("dashboard")),
                                          menuSubItem("Industry Metrics",tabName = "fl", icon = icon("dashboard")),
                                          menuSubItem("Data Bank",tabName = "databank1", icon =icon("fas fa-database"))),
                                 ...
                                 shiny::conditionalPanel(condition = "input.side == 'm1'",
                                                         ...
                                                         boxPlus(solidHeader = T, collapsible = F, collapsed = F, closable = F, title = 'CONTROLS', status = 'primary',width = NULL,
                                                                 introBox(
                                                                 ...
                                                                 introBox(
                                                                     ...
                                                                     uiOutput('slider'),
                                                                          userPost(collapsible = T,collapsed = T,
                                                                                   ...
                                                                                   paste0("*Data are available in monthly increments from 2011 to 2020.")
                                                                          )),data.step = 5, data.intro = steps[5])),
                                                         introBox(boxPlus(solidHeader = T, collapsible = F, collapsed = F, closable = F, title = '', status = 'primary', width = NULL,
                                 ...
                                 shiny::conditionalPanel(condition = "input.side == 'fl'",
                                                         ...
                                                         boxPlus(solidHeader = T, collapsible = F, collapsed = F, closable = F, title = 'CONTROLS', status = 'primary',
                                                                 
                                                                 sliderInput("monthdate", "Choose a Date Range",
                                                                             min = ymd('2014-01-01'), ymd('2020-04-01'),
                                                                 ...
                                                                 width = NULL, userPost(collapsible = T,collapsed = T,
                                                                                        ...
                                                                                        paste0("*Data are available in monthly increments from Jan 2014 to Jan 2019"
                                                                                               #,ymd('2014-01-01')," to ",ymd('2018-12-01'),"."
                                                                                        )),br(),
                                                                 ...
                                                                 boxPlus(solidHeader = T, collapsible = F, collapsed = F, closable = F, title = '', status = 'primary', width = NULL,
                  ...
                  tabItems(
                      tabItem(tabName = "m1",
                              ...
                              fluidRow(
                                  ...
                                  column(width = 12,
                                         introBox(boxPlus(solidHeader = T, collapsible = F, collapsed = F, closable = F, title = 'Industry Trips Map', status = 'success',
                                  ...
                                  absolutePanel(id="controls1",
                                                ...
                                                column(width = 1),
                                                column(width = 11,
                                                       introBox(boxPlus(solidHeader = T, collapsible = T, collapsed = F, closable = F, 
                              ...
                              fluidRow(
                                  introBox(boxPlus(title = "Trends", status = 'warning', width = 12, solidHeader = T, collapsible = F, collapsed = F, closable = F,
                                          fluidRow(
                                              column(width = 3, br(),
                                                     introBox(
                              ...
                              fluidRow(
                                  ...
                                  column(width = 6, setShadow('box'),
                                         introBox(boxPlus(solidHeader = T, collapsible = T, collapsed = T, closable = F, title = 'Industry Trips Table', status = 'warning', 
                                                 withSpinner(DT::dataTableOutput('dth')), width = NULL, br(),br(),br()),data.step = 18, data.intro = steps[18])
                                  ),
                                  
                                  column(width = 6,
                                         introBox(boxPlus(solidHeader = T, collapsible = T, collapsed = T, closable = F, title = "Taxi Zone Metrics", status = 'warning', icon = "fa fa-taxi", h5(htmlOutput("text1")), radioButtons(inputId = "vald", 'Monthly || Daily', choices = c('Monthly', 'Daily'), selected = 'Monthly'), width = NULL,
                      ...
                      tabItem(tabName = "databank1",flipBox(id = 123, back_title = NULL, main_img = "https://png.pngtree.com/svg/20170425/base_data_hover_192723.png"
                                                            ,header_img = NULL, front_title = NULL, height = '1200px', front_btn_text = "Data Dictionary", back_btn_text = "Back to main",
                                                            ...
                                                            fluidRow(
                                                                ...
                                                                column(width = 12,
                                                                       boxPlus(solidHeader = T, collapsible = T, collapsed = F, closable = F, title = 'DATA', status = 'warning', width = NULL,    
                                                                               tabsetPanel(
                                                                                   id = 'dataset',
                                                            ...
                                                            ), back_content = tagList( boxPlus(solidHeader = T, collapsible = T, collapsed = F, closable = F, title = 'DATA DICTIONARY', status = 'warning', width = NULL, DT::dataTableOutput('dict')), br(),br(),br(),br()
                                                            )))
