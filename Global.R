...
data1 <- read_fst('data/trips_updated.fst') %>% dplyr::filter(year_month <= '2020-04-01')
industry_metrics <- read_fst('data/ind_metr_updated.fst')
fhvs <- read.fst('data/fhv.fst') %>% dplyr::filter(year_month <= '2020-04-01', year_month >= '2015-10-01')
